...
const Map<String, String> enUS = {
  ...
  'phone_invalid':
      "Phone number format error. The phone number must start with + and be 9-15 digits long.",
...
//setting_detail_page
  ...
  "description_detail":
      "The restaurant in the lovingly restored Sericulture pavilion at VDNKh has been operating since May 2016. The establishment has two halls, in the summer two large verandas are added to them; around the park, and very close to the Green Theater.",
